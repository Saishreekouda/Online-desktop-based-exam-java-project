...
public class InstructionPage extends JFrame {
	...
	InstructionPage(){
		...
		lblNewLabel.setBounds(13, 11, 713, 70);
		...
		txtrreadTheQuestions.setBackground(new Color(93, 82, 85));
		...
		txtrreadTheQuestions.setBounds(15, 120, 800, 260);
		txtrreadTheQuestions.setForeground(Color.white);
		...
		btnNewButton.setBounds(15, 420, 260, 49);
		...
		btnNewButton_1.setBounds(15, 489, 260, 49);
