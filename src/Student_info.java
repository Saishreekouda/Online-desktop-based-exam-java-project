...
public class Student_info extends JFrame {
	...
	public Student_info() {
		...
		nameList = new ArrayList<String>(); nameList.add("anjal");nameList.add("anjali");nameList.add("aadesh");nameList.add("alka"); 
		passList = new ArrayList<String>();  passList.add("shinchan"); passList.add("shinchan"); passList.add("shinchan2"); passList.add("shinchan4");
		idList = new ArrayList<String>(); idList.add("iit2021031"); idList.add("iit2021031");idList.add("iit2021007"); idList.add("iit2021103"); 
		...
		contentPane = new JPanel(){  
            public void paintComponent(Graphics g) {  
              Image img = Toolkit.getDefaultToolkit().getImage(  
                        Home.class.getResource("/Group 1 .png"));  
