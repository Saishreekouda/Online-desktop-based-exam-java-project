...
public class FINALRESULT extends JFrame {
	...
	FINALRESULT( ){
		...
		result_frame.setBounds(15,200,200,150);
		...
		if(ans>=10) {
		result_frame.setText("\r\n Congratulations! You have passed exam with marks:\r\n");
		}
		else
		{
			result_frame.setText("\r\n Sorry! You have failed exam with marks:\r\n");	
		}
		...
		result_frame.setBounds(10, 128, 400, 100);
		...
		btnNewButton_1.setBounds(10, 267, 260, 39);
